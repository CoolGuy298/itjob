...
const Home = () => {
    ...
    return (
        <div className='flex flex-col'>
            <div
                className={`relative flex flex-col justify-center items-start gap-4 pt pt-32 pb-44 bg-[url('/home.jpg')] bg-cover bg-center bg-opacity-75`}
            >
                <h1 className='absolute top-2 left-20 text-6xl font-black select-none	'>Find your dream IT job now !</h1>
            ...
            <div className='w-2/3 my-8 mx-auto flex justify-center items-center gap-4 flex-wrap'>
             ...
             <p className="text-2xl text-gray-900 dark:text-white">Try these keywords</p>
            </div>
            <div className='w-2/3 my-8 mx-auto flex justify-center items-center gap-4 flex-wrap'>
