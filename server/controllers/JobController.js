...
exports.getAvailableJobs = async (req, res) => {
    try {
        ...
        // Find jobs with endDate greater than or equal to the current date
        const jobs = await Job.find({ endDate: { $gte: currentDate } })
            .populate('jobApplicationCount') // Populate application count
            .populate('companyID', 'companyName'); // Populate company data (only companyName)
